...
class Admin extends CI_Controller
{
    ...
    function user($para1 = '', $para2 = '')
    {
        ...
        if ($para1 == 'do_add') {
            ...
            $tables = array('user', 'user_map', 'product');
    ...
    function youtube_video_update($para1 = "")
    {
        if (!$this->crud_model->admin_permission('youtube_video_update')) {
            redirect(base_url() . 'admin');
        }
        if ($para1 == 'update') {
    ...
    function video_insert($para1 = "", $para2 = "", $para3 = "")
    {
        if (!$this->crud_model->admin_permission('video_insert')) {
            redirect(base_url() . 'admin');
        }
        if ($para1 == 'show_list') {
    ...
    function transaction($para1 = "", $para2 = "")
    {
        ...
        if ($para1 == 'list') {
            ...
            $this->db->where('user_id', $tra_user_id);
