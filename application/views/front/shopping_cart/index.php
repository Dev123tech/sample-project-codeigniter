                        ...
                        <div class="col-lg-12">
                            <div class="cart-shiping-update-wrapper">
                                ...
                                <div class="cart-clear">
                                    <a href="<?php echo base_url(); ?>"><button type="button">Continue Shopping</button></a>
                ...
                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="tax-select">
                                                <input type="text" name="first_name" id="bill_name" placeholder="<?php echo translate('first_name');?>" class="form-control" value="" required >
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="tax-select">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="tax-select mb-25px">
                                                <input type="text" name="phone" id="bill_phone" class="form-control" placeholder="<?php echo translate('phone');?>"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?php echo $user_info->phone; ?>" required/>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="tax-select mb-25px">
                                        ...
                                        <!-- <div class="col-sm-6">
                                            <div class="tax-select mb-25px">
                                                <input type="text" name="state_or_province_code" class="form-control" placeholder="Post Code" value="" required/>
                                            </div>
                                        </div> -->
                                        <div class="col-sm-6">
                                            <div class="tax-select">
                                        ...
                                        <div class="col-sm-4 offset-sm-8 text-right btngra1 " style="display:none;">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="tax-select-wrapper">
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                            <div class="tax-select">
                                                                                <input type="text" name="delivery_first_name" id="del_firstname" placeholder="<?php echo translate('first_name');?>" class="form-control" value="" required >
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                            <div class="tax-select">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <div class="tax-select mb-25px">
                                                                                <input type="text" name="delivery_phone" id="del_phone" class="form-control" placeholder="<?php echo translate('phone');?>"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="" required/>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                            <div class="tax-select mb-25px">
                                                                        ...
                                                                        <!-- <div class="col-sm-6">
                                                                        <div class="tax-select mb-25px">
                                                                            <input type="text" name="delivery_state_or_province_code" class="form-control" placeholder="Post Code" value="" required/>
                                                                        </div>
                                                                    </div> -->
                                                                        <div class="col-sm-6">
                                                                            <div class="tax-select">
                                                                        ...
                                                                        <div class="col-sm-4 offset-sm-8 text-right btngra2 " style="display:none;">
                                                                            <button type="button" class="btn btngra ishipping_api">Next</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                    ...
                    <div class="col-lg-5 col-md-12 mt-md-30px">
                        <div class="grand-totall">
                            ...
                            <!-- <h5>Insurance<span id="insurance"></span></h5> -->
                            ...
                            <div class="total-shipping  ishipping_result" style="display: none;">
                                ...
                                <h5>Freight Fee<span id="ishipping_custom"></span></h5>
                                <h5 style="display: none;">GST (inclusive) <span id="gst-domestic">10%</span></h5>
                                <h5>Duty <span id="ishipping_duty"></span></h5>
                                <h5 class="custom-child" style="display: none;">Alcohol Tax<span id="alcohol-tax"></span></h5>
                                <h5 class="custom-child" style="display: none;">Import Vat<span id="import-vat"></span></h5>
                                <h5 class="custom-child" style="display: none;">Import Duty<span id="import-duty"></span></h5>
                                ...
                                <p id="international-disclaimer" style="display: none;">Government charges are to be paid upon arrival prior to delivery. You will be notified via email after we cleared custom for you</p> 
                            </div>
                            <div class="total-shipping">
                                <ul>
                                    <li>
                                        
                                        <input id="insurance-chk"  type="checkbox" name="insurance" value="" /> 
                                        Insurance <span id="insurance"></span>
                                    </li>
                                </ul>
                            </div>
...
<script type="text/javascript">
    ...
    $(document).on("click","#insurance-chk",function(){
        // if($(this).val() != "AU"){
        
            update_calc_cart()
        //  }
    });
    $(document).on("click",".show-txt",function(){
        $(".custom-child").toggle();
        $(this).toggle();
