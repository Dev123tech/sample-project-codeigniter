                    ...
                    <div class="search-element media-body">
                        <?php
                            ...
                            ?>
                                ...
                                <input type="text" name="query" id="search"  accept-charset="utf-8" class="form-control enterclick" placeholder="<?php echo translate('what_are_you_looking_for');?>"  onkeyup="myFunction()"/>
                                <button class="entersubmit" id="submit-search" disabled><i class="icon-magnifier"></i></button>
