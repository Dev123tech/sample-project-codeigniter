                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo ucwords($info['country']); ?></td>
                            </tr>
                        </tbody>
                    </table>	
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    ...
                                    if($all_o['variationid'] =='1')
                                    {
                                        echo "Each";
                                    }
                                    if($all_o['variationid'] =='2')
                                    {
                                        echo "Six";
                                    }
                                    if($all_o['variationid'] =='3')
                                    {
                                        echo "Twelve";
                                    }
                                ?>
                        ...
                        <table class="table" border="0">
                            <tbody>
                                ...
                                <tr >
                                    ...
                                    <td><?php echo currency('','def').$row['shipping']; ?></td>
                                </tr>
                                <tr>
                                    <td><b><?php echo translate('grand_total');?></b></td>
                                    <td><?php echo currency('','def').$this->cart->format_number($total+$row['shipping']); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div> 
