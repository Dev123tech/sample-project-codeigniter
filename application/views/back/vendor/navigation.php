            ...
            <div class="nano">
                <div class="nano-content">
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <li style="display: none;" <?php if ($page_name == "product") { ?> class="active-link" <?php } ?> style="border-top:1px solid rgba(69, 74, 84, 0.7);">
                        ...
                        if ($physical_check == 'ok' && $digital_check == 'ok') {
                            if (
                                $this->crud_model->vendor_permission('product') ||
                        ...
                        ?>
                                ...
                                <li <?php if (
                                    ...
                                    <ul class="collapse <?php if (
                                        ...
                                        ?>
                                            ...
                                            <li style="display: none;"><?php if (
                                                ...
                                                <ul class="collapse <?php if (
                                                    ...
                                                    if ($this->crud_model->vendor_permission('product_bundle')) {
                                                    ?>
                                                        <li style="display: none;" <?php if ($page_name == "product_bundle") { ?> class="active-link" <?php } ?>>
                                                            <a href="<?php echo base_url(); ?>vendor/product_bundle">
                                                                <i class="fa fa-circle fs_i"></i>
                                        ...
                                        ?>
                                            <!--Menu list item-->
                                            <li style="display:none;" <?php if ($page_name == "digital") { ?> class="active-link" <?php } ?>>
                        ...
                        ?>
                            ...
                            <li <?php if ($page_name == "sales") { ?> class="active-link" <?php } ?>>
                                <a href="<?php echo base_url(); ?>vendor/sales/">
                                    <i class="fa fa-usd"></i>
                                    <span class="menu-title">
                                        <?php echo translate('transaction_history'); ?>
                                    </span>
                                </a>
                            </li>
                        <?php
                        ...
                        ?>
                            <!--Menu list item-->
                            <li style="display: none;"> <?php if ($page_name == "admin_payments") { ?> class="active-link"
                                    <?php } ?>>
                        ...
                        ?>
                                <!--Menu list item-->
                                <li style="display: none;" <?php if ($page_name == "upgrade_history") { ?> class="active-link" <?php } ?>>
                        ...
                        ?>
                            <!--Menu list item-->
                            <li style="display: none;" <?php if ($page_name == "coupon") { ?> class="active-link" <?php } ?>>
                        ...
                        <?php
                        $visible = false;
                        if ($this->crud_model->vendor_permission('report') && $visible == true) {
                        ?>
                            <!--Menu list item-->
                            <li <?php if (
                                    $page_name == "report" ||
                        ...
                        ?>
                            <!--Menu list item-->
                            <li style="display: none;" <?php if ($page_name == "site_settings") { ?> class="active-link" <?php } ?>>
                        ...
                        <?php
                        $visible = false;
                        if ($this->crud_model->vendor_permission('business_settings') && $visible == true) {
                        ?>
