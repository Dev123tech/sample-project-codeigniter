                ...
                <div class="nano-content" style="overflow-x:auto;">
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <li <?php if($page_name=="category" || 
                            ...
                            ?>
                            <!--Menu list item-->
                                <li style="display:none;" <?php if($page_name=="category_digital" || 
                                                $page_name=="sub_category_digital" ||
						...
						?>
                        <li <?php if($page_name=="admin_commission"){?> class="active-link" <?php } ?> 
                            style="border-top:1px solid rgba(69, 74, 84, 0.7);">
                            <a href="<?php echo base_url(); ?>admin/admin_commission">
						...
						<!--Menu list item-->
							<li <?php if($page_name=="category_digital" || 
								...
								<!--digital------------------>
								<ul style="display:none;" class="collapse <?php if($page_name=="category_digital" || 
																$page_name=="sub_category_digital" ||  
																	$page_name=="digital" ){?>
																				 in
																					<?php } ?> >" >
                        ...
                        ?>
                        <!--Menu list item-->
                            <li style="display:none;" <?php if($page_name=="delete_all_categories" || 
                        ...
                        ?>
                        <li  <?php if($page_name=="promocode"){?> class="active-link" <?php } ?> >
                            ...
                            <ul class="collapse <?php if($page_name=="report" || 
                                                            $page_name=="report_stock" ||
                                                                $page_name=="report_wish" ){?>
                                                                             in
                                                                                <?php } ?> ">
                                <li style="display: none;" <?php if($page_name=="report"){?> class="active-link" <?php } ?> >
								...
								?>
                                <li style="display: none;" <?php if($page_name=="report_stock"){?> class="active-link" <?php } ?> >
                        ...
                        <li <?php if($page_name=="vendor" || 
                            ...
                            <ul class="collapse <?php if($page_name=="vendor" || 
                                ...
                                <li style="display: none;" <?php if($page_name=="membership_payment"){?> class="active-link" <?php } ?> >
                                ...
                                <li style="display: none;" <?php if($page_name=="membership"){?> class="active-link" <?php } ?> >
                                    <?php if($this->db->get_where('business_settings', array('type' => 'commission_set'))->row()->value == 'no'){?>
                                ...
                                <li  <?php if($page_name=="vendor_commission"){?> class="active-link" <?php } ?> >
                                    ...
                                    <a href="<?php echo base_url(); ?>admin/vendor_commission/">
                                        <i class="fa fa-circle fs_i"></i>
                                        <?php echo translate('vendor_commission');?>123
                                    </a>
                                    <?php }?>
                                </li>
                                <li style="display: none;"  <?php if($page_name=="slides_vendor"){?> class="active-link" <?php } ?> >
                        ...
                        ?>
                        <li style="display: none;"   <?php if($page_name=="blog" || $page_name=="blog_category" ){?>
                                     class="active-sub" 
                                        <?php } ?> >
                            <a href="#">
                            ...
                            <ul class="collapse <?php if($page_name=="slider" || 
                                ...
                                <li <?php if($page_name=="display_settings"){?>
                                    ...
                                    <ul class="collapse <?php if($page_name=="display_settings"){?>
                                        ...
                                        <li style="display:none;" <?php if($tab == 'contact'){ ?>class="active-link"<?php } ?> >
                                            <a href="<?php echo base_url(); ?>admin/display_settings/contact">
                                                <i class="fa fa-circle fs_i"></i>
                                                    <?php echo translate('contact_page');?>
                                            </a>
                                        </li>
                                         <li style="display:none;" <?php if($tab == 'header'){ ?>class="active-link"<?php } ?> >
                                        ...
                                        <li style="display:none;" <?php if($tab == 'theme'){ ?>class="active-link"<?php } ?> >
                                        ...
                                        <li style="display:none;" <?php if($tab == 'font'){ ?>class="active-link"<?php } ?> >
                                            <a href="<?php echo base_url(); ?>admin/display_settings/font">
                                                <i class="fa fa-circle fs_i"></i>
                                                    <?php echo translate('fonts');?>
                                            </a>
                                        </li>
                                        <li style="display:none;"<?php if($tab == 'preloader'){ ?>class="active-link"<?php } ?> >
								...
								?>                      
								<li style="display: none;"  <?php if($page_name=="page"){?> class="active-link" <?php } ?> >
                        ...
                        <li  <?php if($page_name=="activation" || 
                            ...
                            <ul class="collapse <?php if($page_name=="activation" || 
                                ...
                                <li <?php if($page_name=="refer"){?> class="active-link" <?php } ?> >
                                    <a href="<?php echo base_url(); ?>admin/refer/">
                                        <i class="fa fa-circle fs_i"></i>
                                            <?php echo translate('referral_earn');?>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        ?>
                        <li style="display:none;"  <?php if($page_name=="seo_settings"){?> class="active-link" <?php } ?> >
                        ...
                        <li style="display: none;" <?php if($page_name=="add_video"){?> class="active-link" <?php } ?> >
                        ...
                        <li style="display:none;"  <?php if($page_name=="video_insert"){?> class="active-link" <?php } ?> >
                            <a href="<?php echo base_url(); ?>admin/video_insert">
                                <i class="fa fa-list"></i>
                                <span class="menu-title">
                                    <?php echo 'TV List';?>
                                </span>
                        ...
                        <li  <?php if($page_name=="youtube_video_update"){?> class="active-link" <?php } ?> >
                            <a href="<?php echo base_url(); ?>admin/youtube_video_update">
                                <i class="fa fa-list"></i>
                                <span class="menu-title">
                                    <?php echo 'Youtube Video Update';?>
                                </span>
                            </a>
                        </li>
                        <li <?php  if($page_name=="events" ||$page_name=="events_time_slot" ){?> class="active-sub" <?php } ?>>
                            <a href="#">
                                <i class="fa fa-list"></i>
                                <span class="menu-title">
                                    <?php echo "Event"; ?>
                            ...
                            <ul class="collapse <?php  if($page_name=="events" ||$page_name=="events_time_slot" ){?> in <?php } ?>">
                                <li <?php if($page_name=="events"){?> class="active-link" <?php } ?> >
                                    <a href="<?php echo base_url(); ?>admin/events/">
                                        <i class="fa fa-circle fs_i"></i>
                                            <?php echo translate('live_stream_events');?>
                                    </a>
                                </li>
                                <li <?php if($page_name=="events_time_slot"){?> class="active-link" <?php } ?> >
                                    <a href="<?php echo base_url(); ?>admin/events/events_time_slot/">
                                        <i class="fa fa-circle fs_i"></i>
                                            <?php echo translate('event_time_slot');?>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li <?php if($page_name=="transaction"){?> class="active-link" <?php } ?> >
